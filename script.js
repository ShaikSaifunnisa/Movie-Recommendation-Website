// ---------------------------------------------------------------------------
// Dataset (same as the Python version) — embedded so this runs with no backend
// ---------------------------------------------------------------------------
const MOVIES = [
...
// ratings[userIndex][movieIndex-1] = rating (1-5) or null if not rated
const RATINGS = [
...
// ---------------------------------------------------------------------------
// Content-based filtering: genre vectors + cosine similarity
// ---------------------------------------------------------------------------
...
// ---------------------------------------------------------------------------
// Collaborative filtering: user-user cosine similarity + weighted ratings
// ---------------------------------------------------------------------------
